...
const createMockSupabaseClient = () => {
  console.log('Police app using mock Supabase client - Supabase not configured');
  return {
    auth: {
...
const createSupabaseClient = () => {
  ...
  try {
    console.log('Police app creating Supabase client with URL:', supabaseUrl);
    return createClient(supabaseUrl, supabaseAnonKey);
  } catch (error) {
    console.error('Police app failed to create Supabase client:', error);
    return createMockSupabaseClient();
  }
};
